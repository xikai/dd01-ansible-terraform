...
module "ecs_sg" {
  ...
  env                           = "prod"  
  ecs_sg_name                   = "member-notification-service"
...
module "slb" {
  ...
  env                           = "prod"
  slb_name                      = "member-notification-service"
...
module "ess" {
  source                        = "../../modules/ess"
  env                           = "prod"
  scaling_group_name            = "member-notification-service"
  instance_name                 = "member-notification-service"
  ...
  userdata_VAR_PLAYBOOKS        = [
    ...
    "playbooks/site-member-notification-service.yml",
  ]
}
...
module "rds" {
  ...
  database_name                 = "member-notification-service"
  character_set                 = "utf8"
  username                      = "dadi01"
