...
module "ecs_sg" {
  ...
  env                           = "stg"  
  ecs_sg_name                   = "member-api-gateway"
...
module "ess" {
  source                        = "../../modules/ess"
  env                           = "stg"
  scaling_group_name            = "member-api-gateway"
  instance_name                 = "member-api-gateway"
  ...
  userdata_VAR_PLAYBOOKS        = [
    ...
    "playbooks/site-member-api-gateway.yml",
  ]
}
