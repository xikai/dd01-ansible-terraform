...
module "ess" {
  source                        = "../../modules/ess"
  env                           = "prod"
  scaling_group_name            = "apiserver01"
  instance_name                 = "apiserver01"
  ...
  userdata_VAR_PLAYBOOKS        = [
    ...
    "playbooks/site-prod-apiserver01.yml",
  ]
}