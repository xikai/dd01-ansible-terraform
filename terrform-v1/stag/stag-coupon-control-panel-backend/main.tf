...
terraform {
  backend "s3" {
    ...
    region         = "ap-southeast-1"
    key            = "stag/service/dd01-stg-coupon-control-panel-backend"
  }
}
...
module "ec2_sg" {
  ...
  env                           = "stag"  
  ec2_sg_name                   = "coupon-control-panel-backend"
...
module "rds_sg" {
  ...
  env                           = "stag"
  rds_sg_name                   = "coupon-control-panel-backend"
  vpc_id                        = "vpc-0cb62205eddd91563"
...
module "elb2" {
  ...
  env                           = "stag"  
  elb_name                      = "coupon-control-panel2"
  elb_subnets                   = ["subnet-03640fc8791c09e3f","subnet-0405a8e2b3ed02c6e","subnet-0db6407e7898da68c"]
  elb_security_groups           = ["${module.ec2_sg.ec2_sg_id}"]
  elb_ssl_certificate_id        = "arn:aws:acm:ap-southeast-1:366222927764:certificate/3df89b44-ca73-4046-8c19-0bbb305aef92"
  elb_health_check_target       = "TCP:22"
}
...
module "redis_sg" {
  ...
  env                           = "stag"
  redis_sg_name                 = "coupon-control-panel-backend"
  vpc_id                        = "vpc-0cb62205eddd91563"
...
module "lc_asg" {
  ...
  asg_name                           = "coupon-control-panel-backend"
  ...
  lc_userdata_VAR_PLAYBOOKS = [
    ...
    "playbooks/projects/site-coupon-control-panel-backend.yml",
...
module "cd_app" {
  ...
  cd_app_name = "stag-coupon-control-panel-backend-application"
}

resource "aws_codedeploy_deployment_group" "cd_group_conf" {
  app_name               = "stag-coupon-control-panel-backend-application"
...
module "rds" {
  ...
  rds_identifier                    = "coupon-control-panel-backend"
  rds_username                      = "superadmin"
  rds_password_payload              = "AQICAHitYQE0hKiwrv54Fr6Fg1X6PagRY+eKbzkzcP0b5RzJiQHc8zWRjFFmTwtJVzs5oiJzAAAAejB4BgkqhkiG9w0BBwagazBpAgEAMGQGCSqGSIb3DQEHATAeBglghkgBZQMEAS4wEQQMbpHLNFa2IE1tJvsHAgEQgDcjM3gkFkakdpiYTuONsJ0Cd3Sas2ZpkRJy/BJDjJ3pmP470rHM5xCbqstPjoN6TrKo8QX4svfe"
