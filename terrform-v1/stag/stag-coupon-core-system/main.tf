...
terraform {
  backend "s3" {
    ...
    region         = "ap-southeast-1"
    key            = "stag/service/dd01-stg-coupon-core-system"
  }
}
...
module "ec2_sg" {
  ...
  env                           = "stag"  
  ec2_sg_name                   = "coupon-core-system"
...
module "redis_sg" {
  ...
  env                           = "stag"
  redis_sg_name                 = "coupon-core-system"
  vpc_id                        = "vpc-0cb62205eddd91563"
...
module "lc_asg" {
  ...
  lc_userdata_VAR_PLAYBOOKS = [
    ...
    "playbooks/projects/site-coupon-core-system.yml",
...
module "cd_app" {
  ...
  cd_app_name = "stag-coupon-core-system-application"
}

resource "aws_codedeploy_deployment_group" "cd_group_conf" {
  app_name               = "stag-coupon-core-system-application"
