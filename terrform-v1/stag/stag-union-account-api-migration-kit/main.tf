...
terraform {
  backend "s3" {
    ...
    region         = "ap-southeast-1"
    key            = "stag/service/dd01-stg-union-account-api-migration-kit"
  }
}
...
module "ec2_sg" {
  ...
  env                           = "stag"  
  ec2_sg_name                   = "union-account-api-migration-kit"
...
module "elb" {
  ...
  env                           = "stag"  
  elb_name                      = "union-account-api-kit"
...
module "lc_asg" {
  ...
  asg_name                           = "union-account-api-migration-kit"
  ...
  lc_userdata_VAR_PLAYBOOKS = [
    ...
    "playbooks/projects/site-union-account-api-migration-kit.yml",
...
module "cd_app" {
  ...
  cd_app_name = "stag-union-account-api-migration-kit-application"
}

resource "aws_codedeploy_deployment_group" "cd_group_conf" {
  app_name               = "stag-union-account-api-migration-kit-application"
